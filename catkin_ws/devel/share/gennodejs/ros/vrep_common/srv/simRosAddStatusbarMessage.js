...
class simRosAddStatusbarMessageRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosAddStatusbarMessageRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosAddStatusbarMessageRequest(null);
...
class simRosAddStatusbarMessageResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosAddStatusbarMessageResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosAddStatusbarMessageResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosAddStatusbarMessage'; }
};
