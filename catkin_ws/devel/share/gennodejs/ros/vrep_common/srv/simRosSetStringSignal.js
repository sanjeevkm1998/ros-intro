...
class simRosSetStringSignalRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetStringSignalRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetStringSignalRequest(null);
...
class simRosSetStringSignalResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetStringSignalResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetStringSignalResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosSetStringSignal'; }
};
