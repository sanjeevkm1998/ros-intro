...
class simRosGetJointStateRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosGetJointStateRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosGetJointStateRequest(null);
...
class simRosGetJointStateResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = sensor_msgs.msg.JointState.serialize(obj.state, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosGetJointStateResponse(null);
    // Deserialize message field [result]
    data.result = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [state]
    data.state = sensor_msgs.msg.JointState.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += sensor_msgs.msg.JointState.getMessageSize(object.state);
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosGetJointStateResponse(null);
    ...
    if (msg.state !== undefined) {
      resolved.state = sensor_msgs.msg.JointState.Resolve(msg.state)
    }
    else {
      resolved.state = new sensor_msgs.msg.JointState()
    }
...
module.exports = {
  ...
  md5sum() { return 'e3e87944e85555d62f7a59817ea5aee6'; },
  datatype() { return 'vrep_common/simRosGetJointState'; }
};
