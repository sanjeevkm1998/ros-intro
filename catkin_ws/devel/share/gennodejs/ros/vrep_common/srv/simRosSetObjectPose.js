...
class simRosSetObjectPoseRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetObjectPoseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetObjectPoseRequest(null);
...
class simRosSetObjectPoseResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetObjectPoseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetObjectPoseResponse(null);
...
module.exports = {
  ...
  md5sum() { return '61b308bf14be660ce4de1c3374dc2f73'; },
  datatype() { return 'vrep_common/simRosSetObjectPose'; }
};
