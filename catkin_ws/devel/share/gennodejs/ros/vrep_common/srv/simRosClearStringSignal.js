...
class simRosClearStringSignalRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosClearStringSignalRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosClearStringSignalRequest(null);
...
class simRosClearStringSignalResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosClearStringSignalResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosClearStringSignalResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosClearStringSignal'; }
};
