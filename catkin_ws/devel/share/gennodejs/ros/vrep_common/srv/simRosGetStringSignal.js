...
class simRosGetStringSignalRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosGetStringSignalRequest(null);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.signalName);
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosGetStringSignalRequest(null);
...
class simRosGetStringSignalResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosGetStringSignalResponse(null);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.signalValue);
    return length + 8;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosGetStringSignalResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosGetStringSignal'; }
};
