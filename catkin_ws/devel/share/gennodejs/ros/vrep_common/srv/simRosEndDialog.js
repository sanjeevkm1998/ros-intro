...
class simRosEndDialogRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosEndDialogRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosEndDialogRequest(null);
...
class simRosEndDialogResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosEndDialogResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosEndDialogResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosEndDialog'; }
};
