...
class simRosStartSimulationRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosStartSimulationRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosStartSimulationRequest(null);
    return resolved;
    }
};
...
class simRosStartSimulationResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosStartSimulationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosStartSimulationResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosStartSimulation'; }
};
