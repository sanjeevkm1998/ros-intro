...
class simRosLoadSceneRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosLoadSceneRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosLoadSceneRequest(null);
...
class simRosLoadSceneResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosLoadSceneResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosLoadSceneResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosLoadScene'; }
};
