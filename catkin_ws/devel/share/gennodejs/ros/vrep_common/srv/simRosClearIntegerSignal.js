...
class simRosClearIntegerSignalRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosClearIntegerSignalRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosClearIntegerSignalRequest(null);
...
class simRosClearIntegerSignalResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosClearIntegerSignalResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosClearIntegerSignalResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosClearIntegerSignal'; }
};
