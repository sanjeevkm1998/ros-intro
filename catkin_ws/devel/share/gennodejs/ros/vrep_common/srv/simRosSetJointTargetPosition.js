...
class simRosSetJointTargetPositionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.targetPosition, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetJointTargetPositionRequest(null);
    // Deserialize message field [handle]
    data.handle = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [targetPosition]
    data.targetPosition = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetJointTargetPositionRequest(null);
    ...
    if (msg.targetPosition !== undefined) {
      resolved.targetPosition = msg.targetPosition;
    }
    else {
      resolved.targetPosition = 0.0
    }
...
class simRosSetJointTargetPositionResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosSetJointTargetPositionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosSetJointTargetPositionResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'b23bfbd3cc670ebc2b50d027597762b2'; },
  datatype() { return 'vrep_common/simRosSetJointTargetPosition'; }
};
