...
class simRosRemoveModelRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosRemoveModelRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosRemoveModelRequest(null);
...
class simRosRemoveModelResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosRemoveModelResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosRemoveModelResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosRemoveModel'; }
};
