...
class simRosPauseSimulationRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosPauseSimulationRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosPauseSimulationRequest(null);
    return resolved;
    }
};
...
class simRosPauseSimulationResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosPauseSimulationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosPauseSimulationResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosPauseSimulation'; }
};
