...
class simRosStopSimulationRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosStopSimulationRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosStopSimulationRequest(null);
    return resolved;
    }
};
...
class simRosStopSimulationResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new simRosStopSimulationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simRosStopSimulationResponse(null);
...
module.exports = {
  ...
  datatype() { return 'vrep_common/simRosStopSimulation'; }
};
