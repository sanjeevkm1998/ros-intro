...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosGetObjectPose-request>)))
  ...
  (cl:format cl:nil "#~%# simInt simGetObjectPosition(simInt objectHandle,simInt relativeToObjectHandle,simFloat* position)~%# simInt simGetObjectQuaternion(simInt objectHandle,simInt relativeToObjectHandle,simFloat* quat)~%~%int32 handle~%int32 relativeToObjectHandle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosGetObjectPose-request)))
  "Returns full string definition for message of type 'simRosGetObjectPose-request"
  (cl:format cl:nil "#~%# simInt simGetObjectPosition(simInt objectHandle,simInt relativeToObjectHandle,simFloat* position)~%# simInt simGetObjectQuaternion(simInt objectHandle,simInt relativeToObjectHandle,simFloat* quat)~%~%int32 handle~%int32 relativeToObjectHandle~%~%~%"))
