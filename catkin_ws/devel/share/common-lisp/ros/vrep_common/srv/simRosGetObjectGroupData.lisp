...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosGetObjectGroupData-request>)))
  ...
  (cl:format cl:nil "#~%# simxInt simxGetObjectGroupData(simxInt clientID,simxInt objectType,simxInt dataType,simxInt* handlesCount,simxInt** handles,simxInt* intDataCount,simxInt** intData,simxInt* floatDataCount,simxFloat** floatData,simxInt* stringDataCount,simxChar** stringData,simxInt operationMode)~%#~%~%int32 objectType~%int32 dataType~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosGetObjectGroupData-request)))
  "Returns full string definition for message of type 'simRosGetObjectGroupData-request"
  (cl:format cl:nil "#~%# simxInt simxGetObjectGroupData(simxInt clientID,simxInt objectType,simxInt dataType,simxInt* handlesCount,simxInt** handles,simxInt* intDataCount,simxInt** intData,simxInt* floatDataCount,simxFloat** floatData,simxInt* stringDataCount,simxChar** stringData,simxInt operationMode)~%#~%~%int32 objectType~%int32 dataType~%~%~%"))
