...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosSetSphericalJointMatrix-request>)))
  ...
  (cl:format cl:nil "#~%# simInt simSetSphericalJointMatrix(simInt objectHandle,simFloat* matrix)~%#~%~%int32 handle~%geometry_msgs/Quaternion quaternion~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosSetSphericalJointMatrix-request)))
  "Returns full string definition for message of type 'simRosSetSphericalJointMatrix-request"
  (cl:format cl:nil "#~%# simInt simSetSphericalJointMatrix(simInt objectHandle,simFloat* matrix)~%#~%~%int32 handle~%geometry_msgs/Quaternion quaternion~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
