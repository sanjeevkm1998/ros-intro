...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosTransferFile-request>)))
  ...
  (cl:format cl:nil "#~%# simxInt simxTransferFile(const simxChar* filePathAndName,const simxChar* fileName_serverSide,simxInt timeOut,simxInt operationMode)~%#~%~%uint8[] data~%string fileName~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosTransferFile-request)))
  "Returns full string definition for message of type 'simRosTransferFile-request"
  (cl:format cl:nil "#~%# simxInt simxTransferFile(const simxChar* filePathAndName,const simxChar* fileName_serverSide,simxInt timeOut,simxInt operationMode)~%#~%~%uint8[] data~%string fileName~%~%~%"))
