...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosSetUIButtonLabel-request>)))
  ...
  (cl:format cl:nil "#~%# simInt simSetUIButtonLabel(simInt uiHandle,simInt buttonHandle,const simChar* upStateLabel,const simChar* downStateLabel)~%#~%~%int32 uiHandle~%int32 buttonID~%string upStateLabel~%string downStateLabel~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosSetUIButtonLabel-request)))
  "Returns full string definition for message of type 'simRosSetUIButtonLabel-request"
  (cl:format cl:nil "#~%# simInt simSetUIButtonLabel(simInt uiHandle,simInt buttonHandle,const simChar* upStateLabel,const simChar* downStateLabel)~%#~%~%int32 uiHandle~%int32 buttonID~%string upStateLabel~%string downStateLabel~%~%~%"))
