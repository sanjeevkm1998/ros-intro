...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<simRosDisplayDialog-request>)))
  ...
  (cl:format cl:nil "#~%# simInt simDisplayDialog(const simChar* titleText,const simChar* mainText,simInt dialogType,const simChar* initialText,const simFloat* titleColors,const simFloat* dialogColors,simInt* uiHandle)~%#~%~%string titleText~%string mainText~%int32 dialogType~%string initialText~%float32[] titleColors~%float32[] dialogColors~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'simRosDisplayDialog-request)))
  "Returns full string definition for message of type 'simRosDisplayDialog-request"
  (cl:format cl:nil "#~%# simInt simDisplayDialog(const simChar* titleText,const simChar* mainText,simInt dialogType,const simChar* initialText,const simFloat* titleColors,const simFloat* dialogColors,simInt* uiHandle)~%#~%~%string titleText~%string mainText~%int32 dialogType~%string initialText~%float32[] titleColors~%float32[] dialogColors~%~%~%"))
