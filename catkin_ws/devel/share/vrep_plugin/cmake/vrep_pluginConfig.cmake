...
if("TRUE" STREQUAL "TRUE")
  set(vrep_plugin_SOURCE_PREFIX /home/sanjeev/catkin_ws/src/vrep_plugin)
  set(vrep_plugin_DEVEL_PREFIX /home/sanjeev/catkin_ws/devel)
  ...
  set(vrep_plugin_INSTALL_PREFIX /home/sanjeev/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://www.coppeliarobotics.com " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Jonathan Cacace <jonathan.cacace@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vrep_plugin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vrep_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sanjeev/catkin_ws/src/vrep_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vrep_plugin_NUM_DUMMY_TARGETS)
      set(vrep_plugin_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vrep_plugin::wrapped-linker-option${vrep_plugin_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vrep_plugin_NUM_DUMMY_TARGETS "${vrep_plugin_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vrep_plugin::wrapped-linker-option${vrep_plugin_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vrep_plugin_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vrep_plugin_dep}_FOUND)
      find_package(${vrep_plugin_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vrep_plugin_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(vrep_plugin_EXPORTED_TARGETS ${${vrep_plugin_dep}_EXPORTED_TARGETS})
endforeach()
