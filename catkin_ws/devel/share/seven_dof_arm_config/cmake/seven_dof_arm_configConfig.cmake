...
if("TRUE" STREQUAL "TRUE")
  set(seven_dof_arm_config_SOURCE_PREFIX /home/sanjeev/catkin_ws/src/seven_dof_arm_config)
  set(seven_dof_arm_config_DEVEL_PREFIX /home/sanjeev/catkin_ws/devel)
  ...
  set(seven_dof_arm_config_INSTALL_PREFIX /home/sanjeev/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'jcacace <jonathan.cacace@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'seven_dof_arm_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'seven_dof_arm_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sanjeev/catkin_ws/src/seven_dof_arm_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT seven_dof_arm_config_NUM_DUMMY_TARGETS)
      set(seven_dof_arm_config_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::seven_dof_arm_config::wrapped-linker-option${seven_dof_arm_config_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR seven_dof_arm_config_NUM_DUMMY_TARGETS "${seven_dof_arm_config_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::seven_dof_arm_config::wrapped-linker-option${seven_dof_arm_config_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND seven_dof_arm_config_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(seven_dof_arm_config_EXPORTED_TARGETS ${${seven_dof_arm_config_dep}_EXPORTED_TARGETS})
endforeach()
