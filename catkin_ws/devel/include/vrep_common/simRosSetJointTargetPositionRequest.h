...
bool operator==(const ::vrep_common::simRosSetJointTargetPositionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetJointTargetPositionRequest_<ContainerAllocator2> & rhs)
{
