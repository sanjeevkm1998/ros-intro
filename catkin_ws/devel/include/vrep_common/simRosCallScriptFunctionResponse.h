...
bool operator==(const ::vrep_common::simRosCallScriptFunctionResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosCallScriptFunctionResponse_<ContainerAllocator2> & rhs)
{
  return lhs.result == rhs.result &&
    lhs.outputInts == rhs.outputInts &&
    lhs.outputFloats == rhs.outputFloats &&
    lhs.outputStrings == rhs.outputStrings &&
    lhs.outputBuffer == rhs.outputBuffer;
}
