...
bool operator==(const ::vrep_common::simRosGetIntegerSignalRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetIntegerSignalRequest_<ContainerAllocator2> & rhs)
{
