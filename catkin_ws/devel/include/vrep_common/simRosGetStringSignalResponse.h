...
bool operator==(const ::vrep_common::simRosGetStringSignalResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetStringSignalResponse_<ContainerAllocator2> & rhs)
{
