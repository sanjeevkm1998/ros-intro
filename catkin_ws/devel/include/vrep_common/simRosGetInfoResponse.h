...
bool operator==(const ::vrep_common::simRosGetInfoResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetInfoResponse_<ContainerAllocator2> & rhs)
{
  return lhs.headerInfo == rhs.headerInfo &&
    lhs.simulatorState == rhs.simulatorState &&
    lhs.simulationTime == rhs.simulationTime &&
