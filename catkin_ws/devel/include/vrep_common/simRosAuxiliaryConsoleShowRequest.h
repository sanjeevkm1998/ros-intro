...
bool operator==(const ::vrep_common::simRosAuxiliaryConsoleShowRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosAuxiliaryConsoleShowRequest_<ContainerAllocator2> & rhs)
{
  return lhs.consoleHandle == rhs.consoleHandle &&
    lhs.showState == rhs.showState;
}
