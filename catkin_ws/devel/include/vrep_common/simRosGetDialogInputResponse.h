...
bool operator==(const ::vrep_common::simRosGetDialogInputResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetDialogInputResponse_<ContainerAllocator2> & rhs)
{
