...
bool operator==(const ::vrep_common::simRosAppendStringSignalResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosAppendStringSignalResponse_<ContainerAllocator2> & rhs)
{
