...
bool operator==(const ::vrep_common::simRosCreateDummyResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosCreateDummyResponse_<ContainerAllocator2> & rhs)
{
  return lhs.dummyHandle == rhs.dummyHandle;
}
