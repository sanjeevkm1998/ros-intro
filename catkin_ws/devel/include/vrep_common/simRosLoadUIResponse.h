...
bool operator==(const ::vrep_common::simRosLoadUIResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosLoadUIResponse_<ContainerAllocator2> & rhs)
{
  return lhs.result == rhs.result &&
    lhs.uiHandles == rhs.uiHandles;
}
