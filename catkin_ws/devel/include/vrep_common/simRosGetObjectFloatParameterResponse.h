...
bool operator==(const ::vrep_common::simRosGetObjectFloatParameterResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetObjectFloatParameterResponse_<ContainerAllocator2> & rhs)
{
