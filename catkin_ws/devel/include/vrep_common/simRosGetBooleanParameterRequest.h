...
bool operator==(const ::vrep_common::simRosGetBooleanParameterRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetBooleanParameterRequest_<ContainerAllocator2> & rhs)
{
