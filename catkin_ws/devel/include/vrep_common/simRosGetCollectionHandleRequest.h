...
bool operator==(const ::vrep_common::simRosGetCollectionHandleRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetCollectionHandleRequest_<ContainerAllocator2> & rhs)
{
