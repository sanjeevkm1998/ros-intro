...
bool operator==(const ::vrep_common::simRosSetObjectParentRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetObjectParentRequest_<ContainerAllocator2> & rhs)
{
  return lhs.handle == rhs.handle &&
    lhs.parentHandle == rhs.parentHandle &&
    lhs.keepInPlace == rhs.keepInPlace;
}
