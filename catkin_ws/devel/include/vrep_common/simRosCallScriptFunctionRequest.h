...
bool operator==(const ::vrep_common::simRosCallScriptFunctionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosCallScriptFunctionRequest_<ContainerAllocator2> & rhs)
{
  return lhs.functionNameAtObjectName == rhs.functionNameAtObjectName &&
    lhs.scriptHandleOrType == rhs.scriptHandleOrType &&
    lhs.inputInts == rhs.inputInts &&
    lhs.inputFloats == rhs.inputFloats &&
    lhs.inputStrings == rhs.inputStrings &&
