...
bool operator==(const ::vrep_common::ProximitySensorData_<ContainerAllocator1> & lhs, const ::vrep_common::ProximitySensorData_<ContainerAllocator2> & rhs)
{
  return lhs.detectedPoint == rhs.detectedPoint &&
