...
bool operator==(const ::vrep_common::simRosGetJointStateResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetJointStateResponse_<ContainerAllocator2> & rhs)
{
