...
bool operator==(const ::vrep_common::simRosGetCollisionHandleResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetCollisionHandleResponse_<ContainerAllocator2> & rhs)
{
