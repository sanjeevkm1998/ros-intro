...
bool operator==(const ::vrep_common::simRosSetVisionSensorImageRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetVisionSensorImageRequest_<ContainerAllocator2> & rhs)
{
