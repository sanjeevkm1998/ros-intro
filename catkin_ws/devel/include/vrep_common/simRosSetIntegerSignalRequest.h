...
bool operator==(const ::vrep_common::simRosSetIntegerSignalRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetIntegerSignalRequest_<ContainerAllocator2> & rhs)
{
