...
bool operator==(const ::vrep_common::simRosCopyPasteObjectsResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosCopyPasteObjectsResponse_<ContainerAllocator2> & rhs)
{
  return lhs.result == rhs.result &&
    lhs.newObjectHandles == rhs.newObjectHandles;
}
