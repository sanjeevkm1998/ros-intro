...
bool operator==(const ::vrep_common::VisionSensorData_<ContainerAllocator1> & lhs, const ::vrep_common::VisionSensorData_<ContainerAllocator2> & rhs)
{
  return lhs.triggerState == rhs.triggerState &&
