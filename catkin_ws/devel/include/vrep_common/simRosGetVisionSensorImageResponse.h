...
bool operator==(const ::vrep_common::simRosGetVisionSensorImageResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetVisionSensorImageResponse_<ContainerAllocator2> & rhs)
{
