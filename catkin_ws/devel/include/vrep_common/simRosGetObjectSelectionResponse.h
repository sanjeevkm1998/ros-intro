...
bool operator==(const ::vrep_common::simRosGetObjectSelectionResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetObjectSelectionResponse_<ContainerAllocator2> & rhs)
{
