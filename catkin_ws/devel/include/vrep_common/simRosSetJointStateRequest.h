...
bool operator==(const ::vrep_common::simRosSetJointStateRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetJointStateRequest_<ContainerAllocator2> & rhs)
{
  return lhs.handles == rhs.handles &&
    lhs.setModes == rhs.setModes &&
