...
bool operator==(const ::vrep_common::simRosSetArrayParameterRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetArrayParameterRequest_<ContainerAllocator2> & rhs)
{
