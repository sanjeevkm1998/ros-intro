...
bool operator==(const ::vrep_common::simRosGetBooleanParameterResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetBooleanParameterResponse_<ContainerAllocator2> & rhs)
{
