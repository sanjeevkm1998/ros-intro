...
bool operator==(const ::vrep_common::simRosGetObjectGroupDataResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetObjectGroupDataResponse_<ContainerAllocator2> & rhs)
{
  return lhs.handles == rhs.handles &&
    lhs.intData == rhs.intData &&
