...
bool operator==(const ::vrep_common::simRosSetObjectQuaternionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetObjectQuaternionRequest_<ContainerAllocator2> & rhs)
{
