...
bool operator==(const ::vrep_common::simRosBreakForceSensorResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosBreakForceSensorResponse_<ContainerAllocator2> & rhs)
{
