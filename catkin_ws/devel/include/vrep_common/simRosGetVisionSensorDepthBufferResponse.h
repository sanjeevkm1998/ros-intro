...
bool operator==(const ::vrep_common::simRosGetVisionSensorDepthBufferResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetVisionSensorDepthBufferResponse_<ContainerAllocator2> & rhs)
{
