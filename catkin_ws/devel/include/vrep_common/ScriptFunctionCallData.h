...
bool operator==(const ::vrep_common::ScriptFunctionCallData_<ContainerAllocator1> & lhs, const ::vrep_common::ScriptFunctionCallData_<ContainerAllocator2> & rhs)
{
  return lhs.intData == rhs.intData &&
    lhs.floatData == rhs.floatData &&
    lhs.stringData == rhs.stringData &&
    lhs.bufferData == rhs.bufferData;
}
