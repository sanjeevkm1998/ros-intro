...
bool operator==(const ::vrep_common::simRosDisablePublisherRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosDisablePublisherRequest_<ContainerAllocator2> & rhs)
{
