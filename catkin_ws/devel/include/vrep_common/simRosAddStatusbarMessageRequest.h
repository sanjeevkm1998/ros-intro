...
bool operator==(const ::vrep_common::simRosAddStatusbarMessageRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosAddStatusbarMessageRequest_<ContainerAllocator2> & rhs)
{
