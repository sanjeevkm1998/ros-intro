...
bool operator==(const ::vrep_common::simRosRemoveObjectRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosRemoveObjectRequest_<ContainerAllocator2> & rhs)
{
