...
bool operator==(const ::vrep_common::simRosGetFloatingParameterResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetFloatingParameterResponse_<ContainerAllocator2> & rhs)
{
