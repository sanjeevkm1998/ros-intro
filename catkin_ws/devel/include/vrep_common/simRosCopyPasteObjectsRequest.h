...
bool operator==(const ::vrep_common::simRosCopyPasteObjectsRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosCopyPasteObjectsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.objectHandles == rhs.objectHandles;
}
