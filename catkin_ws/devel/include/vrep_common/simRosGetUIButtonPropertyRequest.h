...
bool operator==(const ::vrep_common::simRosGetUIButtonPropertyRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetUIButtonPropertyRequest_<ContainerAllocator2> & rhs)
{
