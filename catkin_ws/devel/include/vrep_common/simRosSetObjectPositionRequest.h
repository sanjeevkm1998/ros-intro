...
bool operator==(const ::vrep_common::simRosSetObjectPositionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetObjectPositionRequest_<ContainerAllocator2> & rhs)
{
