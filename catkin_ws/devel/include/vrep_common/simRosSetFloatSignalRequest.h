...
bool operator==(const ::vrep_common::simRosSetFloatSignalRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetFloatSignalRequest_<ContainerAllocator2> & rhs)
{
