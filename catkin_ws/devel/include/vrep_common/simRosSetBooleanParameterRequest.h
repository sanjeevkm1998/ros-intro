...
bool operator==(const ::vrep_common::simRosSetBooleanParameterRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetBooleanParameterRequest_<ContainerAllocator2> & rhs)
{
