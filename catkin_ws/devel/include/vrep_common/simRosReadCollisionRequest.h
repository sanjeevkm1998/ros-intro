...
bool operator==(const ::vrep_common::simRosReadCollisionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosReadCollisionRequest_<ContainerAllocator2> & rhs)
{
