...
bool operator==(const ::vrep_common::simRosAuxiliaryConsoleOpenRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosAuxiliaryConsoleOpenRequest_<ContainerAllocator2> & rhs)
{
