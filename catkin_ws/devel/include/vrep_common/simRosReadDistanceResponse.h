...
bool operator==(const ::vrep_common::simRosReadDistanceResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosReadDistanceResponse_<ContainerAllocator2> & rhs)
{
