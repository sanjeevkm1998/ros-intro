...
bool operator==(const ::vrep_common::simRosReadProximitySensorResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosReadProximitySensorResponse_<ContainerAllocator2> & rhs)
{
  return lhs.result == rhs.result &&
    lhs.detectedPoint == rhs.detectedPoint &&
    lhs.detectedObject == rhs.detectedObject &&
