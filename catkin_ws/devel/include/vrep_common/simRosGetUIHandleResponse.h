...
bool operator==(const ::vrep_common::simRosGetUIHandleResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetUIHandleResponse_<ContainerAllocator2> & rhs)
{
