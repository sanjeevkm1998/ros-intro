...
bool operator==(const ::vrep_common::simRosGetUIButtonPropertyResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetUIButtonPropertyResponse_<ContainerAllocator2> & rhs)
{
