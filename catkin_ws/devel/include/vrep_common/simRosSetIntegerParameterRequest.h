...
bool operator==(const ::vrep_common::simRosSetIntegerParameterRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetIntegerParameterRequest_<ContainerAllocator2> & rhs)
{
