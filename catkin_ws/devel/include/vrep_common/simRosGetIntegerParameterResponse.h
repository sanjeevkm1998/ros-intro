...
bool operator==(const ::vrep_common::simRosGetIntegerParameterResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetIntegerParameterResponse_<ContainerAllocator2> & rhs)
{
