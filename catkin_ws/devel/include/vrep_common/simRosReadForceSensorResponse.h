...
bool operator==(const ::vrep_common::simRosReadForceSensorResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosReadForceSensorResponse_<ContainerAllocator2> & rhs)
{
