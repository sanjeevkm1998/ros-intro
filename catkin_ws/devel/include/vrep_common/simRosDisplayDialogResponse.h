...
bool operator==(const ::vrep_common::simRosDisplayDialogResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosDisplayDialogResponse_<ContainerAllocator2> & rhs)
{
  return lhs.dialogHandle == rhs.dialogHandle &&
    lhs.uiHandle == rhs.uiHandle;
}
