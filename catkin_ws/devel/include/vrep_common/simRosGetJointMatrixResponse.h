...
bool operator==(const ::vrep_common::simRosGetJointMatrixResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetJointMatrixResponse_<ContainerAllocator2> & rhs)
{
