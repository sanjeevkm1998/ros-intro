...
bool operator==(const ::vrep_common::simRosEnableSubscriberRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosEnableSubscriberRequest_<ContainerAllocator2> & rhs)
{
  return lhs.topicName == rhs.topicName &&
    lhs.queueSize == rhs.queueSize &&
    lhs.streamCmd == rhs.streamCmd &&
    lhs.auxInt1 == rhs.auxInt1 &&
    lhs.auxInt2 == rhs.auxInt2 &&
    lhs.auxString == rhs.auxString;
}
