...
bool operator==(const ::vrep_common::simRosSetObjectSelectionRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetObjectSelectionRequest_<ContainerAllocator2> & rhs)
{
