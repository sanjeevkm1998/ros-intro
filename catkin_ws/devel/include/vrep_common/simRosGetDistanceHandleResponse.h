...
bool operator==(const ::vrep_common::simRosGetDistanceHandleResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetDistanceHandleResponse_<ContainerAllocator2> & rhs)
{
