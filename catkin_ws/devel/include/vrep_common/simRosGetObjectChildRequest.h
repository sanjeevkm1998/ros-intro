...
bool operator==(const ::vrep_common::simRosGetObjectChildRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetObjectChildRequest_<ContainerAllocator2> & rhs)
{
