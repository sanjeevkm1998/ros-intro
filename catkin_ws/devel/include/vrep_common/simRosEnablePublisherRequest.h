...
bool operator==(const ::vrep_common::simRosEnablePublisherRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosEnablePublisherRequest_<ContainerAllocator2> & rhs)
{
