...
bool operator==(const ::vrep_common::simRosSetSphericalJointMatrixRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosSetSphericalJointMatrixRequest_<ContainerAllocator2> & rhs)
{
