...
bool operator==(const ::vrep_common::simRosGetStringParameterResponse_<ContainerAllocator1> & lhs, const ::vrep_common::simRosGetStringParameterResponse_<ContainerAllocator2> & rhs)
{
