...
bool operator==(const ::vrep_common::simRosTransferFileRequest_<ContainerAllocator1> & lhs, const ::vrep_common::simRosTransferFileRequest_<ContainerAllocator2> & rhs)
{
