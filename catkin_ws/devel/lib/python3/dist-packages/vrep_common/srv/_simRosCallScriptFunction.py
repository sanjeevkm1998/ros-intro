...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.scriptHandleOrType
      buff.write(_get_struct_i().pack(_x))
      length = len(self.inputInts)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.inputInts))
      length = len(self.inputFloats)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.inputFloats))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.functionNameAtObjectName = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.inputInts = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.inputFloats = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.inputStrings = []
      ...
      if python3:
        self.inputBuffer = str[start:end].decode('utf-8', 'rosmsg')
      else:
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.outputInts))
      length = len(self.outputFloats)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.outputFloats))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.outputInts = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.outputFloats = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.outputStrings = []
      ...
      if python3:
        self.outputBuffer = str[start:end].decode('utf-8', 'rosmsg')
      else:
