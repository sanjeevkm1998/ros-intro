...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.titleColors))
      length = len(self.dialogColors)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.dialogColors))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.titleText = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.mainText = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.initialText = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.titleColors = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.dialogColors = s.unpack(str[start:end])
      return self
