...
"""autogenerated by genpy from vrep_common/simRosSetVisionSensorImageRequest.msg. Do not edit."""
import codecs
import sys
...
class simRosSetVisionSensorImageRequest(genpy.Message):
  _md5sum = "e6c2b6fb7ff58cb14731c9526391a588"
  _type = "vrep_common/simRosSetVisionSensorImageRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(simRosSetVisionSensorImageRequest, self).__init__(*args, **kwds)
...
class simRosSetVisionSensorImageResponse(genpy.Message):
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(simRosSetVisionSensorImageResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class simRosSetVisionSensorImage(object):
  ...
  _request_class  = simRosSetVisionSensorImageRequest
  _response_class = simRosSetVisionSensorImageResponse
