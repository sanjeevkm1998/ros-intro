...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i4d().pack(_x.handle, _x.relativeToObjectHandle, _x.quaternion.x, _x.quaternion.y, _x.quaternion.z, _x.quaternion.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.handle, _x.relativeToObjectHandle, _x.quaternion.x, _x.quaternion.y, _x.quaternion.z, _x.quaternion.w,) = _get_struct_2i4d().unpack(str[start:end])
      return self
