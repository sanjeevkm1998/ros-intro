...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i3d().pack(_x.handle, _x.relativeToObjectHandle, _x.position.x, _x.position.y, _x.position.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.handle, _x.relativeToObjectHandle, _x.position.x, _x.position.y, _x.position.z,) = _get_struct_2i3d().unpack(str[start:end])
      return self
