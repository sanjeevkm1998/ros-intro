...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.setModes.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.setModes.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      ...
      for val1 in self.values.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.values.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.values.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.values.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.values.data = s.unpack(str[start:end])
      return self
