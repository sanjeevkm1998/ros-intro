...
"""autogenerated by genpy from vrep_common/ObjectGroupData.msg. Do not edit."""
import codecs
import sys
...
class ObjectGroupData(genpy.Message):
  _md5sum = "d73f2682eafdfd3c477ba05ceeae1ada"
  _type = "vrep_common/ObjectGroupData"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       handles,intData,floatData,stringData
    ...
    """
    if args or kwds:
      super(ObjectGroupData, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.handles.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.handles.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.handles.data))
      ...
      for val1 in self.intData.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.intData.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.intData.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.intData.data))
      ...
      for val1 in self.floatData.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.floatData.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.floatData.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.floatData.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.handles.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.intData.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.floatData.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.stringData.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
